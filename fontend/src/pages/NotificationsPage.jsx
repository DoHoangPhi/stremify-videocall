...
import { BellIcon, ClockIcon, MessageSquareIcon, UserCheckIcon, UserIcon } from 'lucide-react';
...
const NotificationsPage = () => {
  ...
  const { mutate: acceptRequestMutatiopn, isPending } = useMutation({
                        ...
                        <div className='card-body p-4'>
                          <div className='flex items-center justify-between'>
                            ...
                            <button className='btn btn-primary btn-sm'
                              onClick={() => acceptRequestMutatiopn(request._id)}
                              disabled={isPending}>
                              Accept
                            </button>
                        ...
                        <div className='card-body p-4'>
                          <div className='flex items-center gap-3'>
                            ...
                            <div className='flex-1'>
                              ...
                              <p className='text-xs items-center opacity-70'>
