...
const SignUpPage = () => {
  ...
  const {isPending, error, signupMutattion} = useSignUp();
  
  const handleSignup = (e) => {
    e.preventDefault();
    signupMutattion(signupData);
  }
          ...
          <div className='w-full'>
            <form onSubmit={handleSignup}>
              <div className='space-y-4'>
                <div>
                  <h2 className='text-xl font-serif'>Create an Account</h2>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='form-control'>
                    <label className='label cursor-pointer justify-start gap2'>
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            ...
            <div className='text-center space-y-3 mt-6'>
              <h2 className='text-xl font-serif'>Connect with language partners worldwide</h2>
